...
public class MyRedBlackBST7< Key extends Comparable< Key >, Value > {
    ...
    public static void main( String[] args ) {
        ...
        MyRedBlackBST7< String, String > bst = new MyRedBlackBST7< String, String >();
