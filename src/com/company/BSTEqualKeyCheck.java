...
public class BSTEqualKeyCheck< Key extends Comparable< Key >, Value > {
    ...
    public static void main( String[] args ) {
        ...
        BSTEqualKeyCheck< Integer, Integer > bst = new BSTEqualKeyCheck< Integer, Integer >();
        ...
        StdOut.println( "DEBUG: bst.hasNoDuplicates(): " + bst.hasNoDuplicates( bst.root ) );
    }
}
