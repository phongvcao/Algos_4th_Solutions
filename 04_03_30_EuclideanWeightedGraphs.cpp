...
public:
    ...
    EuclideanEdgeWeightedGraph( int V )
        : V( V ),
          adj( V ),
          vertices( V )
    {
    ...
    virtual ~EuclideanEdgeWeightedGraph() {
        // not implemented
    }
    ...
    void addVertex( int vertex, Point2D point ) {
    ...
    friend ostream& operator <<( ostream& out, const EuclideanEdgeWeightedGraph& G ) {
...
int main( int argc, char ** argv ) {
    ...
    EuclideanEdgeWeightedGraph ewGraph( 8 );

    for ( int i = 0; i < 8; ++i ) {
        Point2D point( i, i );
        ewGraph.addVertex( i, point );
    }
