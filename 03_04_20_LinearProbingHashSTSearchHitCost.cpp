...
public:
    ...
    int averageSearchHitCost() {
        return searchHitTotalCost / searchHitCount;
    }
...
int main( int argc, char ** argv ) {
    ...
    cout << "\nDEBUG: hashST (averageSearchHitCost()): " << hashST.averageSearchHitCost() << endl;
