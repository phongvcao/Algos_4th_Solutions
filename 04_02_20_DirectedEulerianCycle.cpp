...
// Eulerian Cycle connects each edge exactly once
// Digraph has Eulerian Cycle when:
// - The whole Digraph is connected
// - Each vertex has its indegree equal to outdegree
class EulerianCycle {
private:
    ...
    vector< int > id;
    bool eulerianCycle = true;
    int count = 0;

public:

    EulerianCycle( const Digraph& G )
        : inDegrees( G.getV() ),
          outDegrees( G.getV() ),
          marked( G.getV() ),
          id( G.getV() )
...
int main( int argc, char ** argv ) {
    ...
    EulerianCycle ec( dGraph );
    cout << "DEBUG: ec.hasEulerianCycle(): \n" << ec.hasEulerianCycle() << endl;
    ...
    EulerianCycle ec1( dGraph1 );
    cout << "DEBUG: ec1.hasEulerianCycle(): \n" << ec1.hasEulerianCycle() << endl;
