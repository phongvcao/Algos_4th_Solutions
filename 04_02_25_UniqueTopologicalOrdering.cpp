...
// Digraph has unique topological ordering if and only if there is a directed edge between
// each pair of consecutive vertices in the topological order.
class UniqueTopologicalOrdering {
private:
    bool uniqueTopoOrdering = true;

public:

    UniqueTopologicalOrdering( const Digraph& G ) {
    ...
    virtual ~UniqueTopologicalOrdering() {
        // not implemented
    }

    bool hasUniqueTopoOrdering() const {
        return uniqueTopoOrdering;
    }
};
...
int main( int argc, char ** argv ) {
    ...
    UniqueTopologicalOrdering uto( dGraph );
    cout << "DEBUG: uto.hasUniqueTopoOrdering(): \n" << uto.hasUniqueTopoOrdering() << endl;
    ...
    UniqueTopologicalOrdering uto1( dGraph1 );
    cout << "DEBUG: uto1.hasUniqueTopoOrdering(): \n" << uto1.hasUniqueTopoOrdering() << endl;
