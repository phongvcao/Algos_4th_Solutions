...
public class RedBlackBSTBottom234Tree< Key extends Comparable< Key >, Value > {
    ...
    public RedBlackBSTBottom234Tree() {
        // Not implemented
    }
    ...
    public Node put( Node h, Key key, Value value ) {
        ...
        if ( cmp < 0 ) {
            /* if ( isRed( h.left ) && isRed( h.right ) ) {
                // If we're going to insert to left of h.left
                if ( h.right != null && key.compareTo( h.left.key ) < 0 && ( h.left.left == null ) ) {
                    flipColors( h );
                }

                // If we're going to insert to right of h.left
                if ( h.right != null && key.compareTo( h.left.key ) > 0 && ( h.left.right == null ) ) {
                    flipColors( h );
                }
            } */
            h.left = put( h.left, key, value );
        } else if ( cmp > 0 ) {
            /* // If we're going to insert to left of h.right
            if ( h.right != null && key.compareTo( h.right.key ) < 0 && ( h.right.left == null ) ) {
                flipColors( h );
            }

            // If we're going to insert to right of h.right
            if ( h.right != null && key.compareTo( h.right.key ) > 0 && ( h.right.right == null ) ) {
                flipColors( h );
            } */
    ...
    public static void main( String args[] ) {
        ...
        RedBlackBSTBottom234Tree< String, String > bst = new RedBlackBSTBottom234Tree< String, String >();
