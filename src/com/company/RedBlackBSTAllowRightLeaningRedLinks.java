...
public class RedBlackBSTAllowRightLeaningRedLinks< Key extends Comparable< Key >, Value > {
    ...
    public RedBlackBSTAllowRightLeaningRedLinks() {
        // Not implemented
    }
    ...
    public static void main( String[] args ) {
        ...
        RedBlackBSTAllowRightLeaningRedLinks< String, String > bst = new RedBlackBSTAllowRightLeaningRedLinks< String, String >();
