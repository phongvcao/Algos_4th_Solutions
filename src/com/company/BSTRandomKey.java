...
public class BSTRandomKey< Key extends Comparable< Key >, Value > {
    ...
    public Key randomKey() {
        ...
        return select( rand.nextInt( size() ) );
    }
    ...
    public static void main( String[] args ) {
        ...
        BSTRandomKey< Integer, Integer > bst = new BSTRandomKey< Integer, Integer >();
        ...
        for ( int i = 0; i < 10; ++i ) {
            StdOut.println( "DEBUG: bst.randomKey(): " + bst.randomKey() );
        }
    }
}
