...
public class RedBlackBSTSoftwareCaching< Key extends Comparable< Key >, Value > {
    ...
    public Node put( Node h, Key key, Value value ) {
        ...
        if ( cmp < 0 ) {
            ...
            if ( h.left.key.compareTo( key ) == 0 ) {
                mostRecentlyAccessed = h.left;
            }
        } else if ( cmp > 0 ) {
            h.right = put( h.right, key, value );
            if ( h.right.key.compareTo( key ) == 0 ) {
                mostRecentlyAccessed = h.right;
            }
        } else {
            h.value = value;
            mostRecentlyAccessed = h;
        }
    ...
    public static void main( String[] args ) {
        ...
        RedBlackBSTSoftwareCaching< String, String > bst = new RedBlackBSTSoftwareCaching< String, String >();
        ...
        StdOut.println( "DEBUG: bst.get(): " + bst.get( "A" ) );
        StdOut.println( "DEBUG: bst.mostRecentlyAccessed: " + bst.mostRecentlyAccessed );
    }
}
