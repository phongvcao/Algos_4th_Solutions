...
public class MyRedBlackBST4< Key extends Comparable< Key >, Value > {
    ...
    public int height( Node h, int count ) {
        ...
        if ( ( h.left != null ) && ( h.left.color == BLACK ) ) {
            leftHeight = height( h.left, count + 1 );
        } else {
            leftHeight = height( h.left, count );
        }

        if ( ( h.right != null ) && ( h.right.color == BLACK ) ) {
            rightHeight = height( h.right, count + 1 );
        } else {
            rightHeight = height( h.right, count );
        }
    ...
    public static void main( String[] args ) {
        ...
        MyRedBlackBST4< String, String > bst = new MyRedBlackBST4< String, String >();
