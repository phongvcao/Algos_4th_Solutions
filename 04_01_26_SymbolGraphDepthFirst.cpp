...
public:
    ...
    static void testSymbolGraph() {
        ...
        DFP dfp( *( sg.getG() ), sg.index( "JFK" ) );

        cout << "DEBUG: graph: \n" << sg.getG()->toString() << endl;
        cout << "DEBUG: dfp: \n" << dfp.toString() << endl;
        cout << "JFK -> LAS" << endl;

        int destIdx = sg.index( "LAS" );
        for ( int w : dfp.pathTo( destIdx ) ) {
            cout << "    " << sg.name( w ) << endl;
        }
    }
};
...
int main( int argc, char ** argv ) {
    ...
    DFP dfp( *( sg.getG() ), sg.index( "Bacon, Kevin" ) );
    cout << "DEBUG: graph: \n" << sg.getG()->toString() << endl;
    cout << "DEBUG: dfp: \n" << dfp.toString() << endl;
    cout << "Bacon, Kevin -> Kidman, Nicole" << endl;

    int destIdx = sg.index( "Kidman, Nicole" );
    for ( int w : dfp.pathTo( destIdx ) ) {
        cout << "    " << sg.name( w ) << endl;
    }
