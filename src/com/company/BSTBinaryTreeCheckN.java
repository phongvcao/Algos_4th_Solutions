...
public class BSTBinaryTreeCheckN< Key extends Comparable< Key >, Value > {
    ...
    public static void main( String[] args ) {
        ...
        BSTBinaryTreeCheckN< Integer, Integer > bst = new BSTBinaryTreeCheckN< Integer, Integer >();
        for ( int i = 0; i < keyArr.length; ++i ) {
            bst.put( keyArr[ i ], valueArr[ i ] );
        }

        StdOut.println( "DEBUG: bst: " + bst.toString() );
        StdOut.println( "DEBUG: bst.isBinaryTree(): " + bst.isBinaryTree( bst.root ) );
        bst.deleteMin();
        bst.deleteMax();
        StdOut.println( "DEBUG: bst: " + bst.toString() );
        StdOut.println( "DEBUG: bst.isBinaryTree(): " + bst.isBinaryTree( bst.root ) );
