...
public class RedBlackBSTDeleteMin< Key extends Comparable< Key >, Value > {
    ...
    public void deleteMinBSTOld() {
        root = deleteMinBSTOld( root );
    }

    public Node deleteMinBSTOld( Node h ) {
        if ( h == null ) return null;
        if ( h.left == null ) return h.right;
        h.left = deleteMinBSTOld( h.left );
        h.N = size( h.left ) + size( h.right ) + 1;
        return h;
    }
    ...
    public Node moveRedLeft( Node h ) {
        // This is only called when h.left and h.left.left are both BLACK
        flipColors( h );
    ...
    public static void main( String[] args ) {
        ...
        RedBlackBSTDeleteMin< String, String > bst = new RedBlackBSTDeleteMin< String, String >();
