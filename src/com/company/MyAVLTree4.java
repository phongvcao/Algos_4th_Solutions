...
public class MyAVLTree4< Key extends Comparable< Key >, Value > {
    ...
    public Node put( Node h, Key key, Value value ) {
        if ( h == null ) return new Node( key, value, 1, 0 );
    ...
    public int balanceFactor( Node h ) {
    ...
    public static void main( String[] args ) {
        ...
        MyAVLTree4< String, String > bst = new MyAVLTree4< String, String >();
