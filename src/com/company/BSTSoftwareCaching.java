...
public class BSTSoftwareCaching< Key extends Comparable< Key >, Value > {
    ...
    public BSTSoftwareCaching() {
        // Not implemented
    }

    public void put( Key key, Value value ) {
        if ( ( this.mostRecentlyAccessed != null ) && ( this.mostRecentlyAccessed.key.compareTo( key ) == 0 ) ) {
            this.mostRecentlyAccessed.value = value;
            return;
        }
    ...
    public Node put( Node x, Key key, Value value ) {
        ...
        this.mostRecentlyAccessed = x;
        return x;
    }

    public Value get( Key key ) {
        if ( ( this.mostRecentlyAccessed != null ) && ( this.mostRecentlyAccessed.key.compareTo( key ) == 0 ) ) {
            return this.mostRecentlyAccessed.value;
        }
    ...
    public static void main( String[] args ) {
        ...
        BSTSoftwareCaching< Integer, Integer > bst = new BSTSoftwareCaching< Integer, Integer >();
        for ( int i = 0; i < keyArr.length; ++i ) {
            bst.put( keyArr[ i ], valueArr[ i ] );
        }

        StdOut.println( "DEBUG: bst: " + bst.toString() );
        StdOut.println( "DEBUG: bst.get( 10 ): " + bst.get( 10 ) );
        StdOut.println( "DEBUG: bst.get( 10 ): " + bst.get( 10 ) );
    }
}
